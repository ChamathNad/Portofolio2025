...
export default function Home() {
  ...
  return (
      <div className="w-full p-1">
        <Container className="flex-row justify-center bg-background w-full min-h-[80vh] lg:max-w-[1200px]">
          <hr className="custom-hr"/>
          <div className="mx-auto flex flex-col md:flex-row justify-between font-family-Lufga lg:text-[20px] px-15 py-6 duration-600">
            <div className="flex flex-[2] items-center justify-center">
              <Image
                  ...
                  className="w-[50%] lg:w-[70%] h-fit rounded-4xl border-2 border-Primary-400"
          ...
          <div className='w-full h-auto justify-start flex'>
            <div className='py-[3%] not-xl:w-[100vh] flex px-[15%] z-5 font-family-Lufga dark:text-white duration-200'>
              <span className='flex-[1] font-bold text-4xl text-Primary-500'>Educational Hystory</span>
            </div>
          </div>
          <div className='w-full flex flex-col px-[5%]'>
            {schoolData.map((exp, index) => (
              <WorkXPRow key={index} place={exp.place} position={exp.title} date={exp.time} desc={exp.description} 
                          odd={index % 2 == 0} classdataBase="lg:text-[20px] text-[12px] " classdataDesc="text-[12px] lg:text-[18px]"  nodeSize=' w-[30px] h-[30px] md:w-[46px] md:h-[46px]'/>
            ))}
          </div>
          <hr className="custom-hr"/>
          <div className='w-full flex-col h-auto justify-start flex'>
            <div className='py-[3%] not-xl:w-[100vh] flex px-[15%] z-5 font-family-Lufga dark:text-white duration-200'>
              <span className='flex-[1] font-bold text-4xl text-Primary-500'>Projects</span>
            </div>
          ...
          <div className='w-full h-auto justify-start flex'>
            <div className='py-[3%] not-xl:w-[100vh] flex px-[15%] z-5 font-family-Lufga dark:text-white duration-200'>
              <span className='flex-[1] font-bold text-4xl text-Primary-500'>Work Hystory</span>
            </div>
          </div>
          <div className='w-full flex flex-col px-[5%]'>
          ...
          <div className='w-full h-auto justify-start flex'>
            <div className='py-[3%] not-xl:w-[100vh] flex px-[15%] z-5 font-family-Lufga dark:text-white duration-200'>
              <span className='flex-[1] font-bold text-4xl text-Primary-500'>Tools & Technologies</span>
            </div>
          </div>
          <div className='w-full mx-auto h-auto justify-center flex '>
            <div className="flex flex-wrap justify-between gap-y-6 gap-x-8  px-[15%] py-[3%] z-5 font-family-Lufga dark:text-white duration-200">
              {ToolsData.map((exp, index) => (
                <ToolIcon key={index} imageLink={exp.link} logoName={exp.name} invert={exp.invert} className="w-[30%] md:w-[20%]"/>
              ))}            
            </div>            
          </div>
          <hr className="custom-hr"/>
