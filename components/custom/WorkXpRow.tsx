...
export default function WorkXPRow({
    ...
    return (
        <div className={`${classdataBase} flex mx-auto gap-[10%] grid-cols-3 dark:text-white font-family-Lufga w-[80%] py-[2%] md:px-[2%] duration-200`}>
                ...
                <div className="flex flex-[1] mx-auto justify-center items-center">
                    <div className={`relative ${nodeSize} aspect-[1/1] rounded-full border-2 border-gray-400 border-dashed flex items-center justify-center`}>
                        ...
                        <div className="absolute left-1/2 transform -translate-x-1/2 -translate-y-[50%]
                                    w-px h-[200%] border-l-2 border-dashed border-gray-400 pointer-events-none"
                        />
                    </div>
                </div>
                <div className='flex flex-col flex-[4]'>
