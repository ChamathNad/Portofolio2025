    ...
    return (
       <div className="relative w-[100%] shadow-xl group/card">
        <div className="rounded-[32px] w-full max-h-[450px] overflow-hidden bottom-right px-5 pt-8 duration-500
              ...
              {/* Title */}
              <h2 className="text-white text-[20%] font-semibold mb-[2%] font-family-Lufga">{children}</h2>
        ...
        {/* Arrow Button */}
              <div className="absolute bottom-1 right-1 bg-gray-800 group-hover/card:bg-Primary-500 p-2 rounded-full flex items-center justify-center z-20 border border-white/20 text-white  duration-500">
                <ArrowUpRightIcon weight='bold' className='text-[40%]'/>
