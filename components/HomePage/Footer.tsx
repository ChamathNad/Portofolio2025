            ...
            <div className='w-full h-full flex overflow-clip'>
              ...
              <div className='flex mx-auto gap-[5%] py-[3%] grid-cols-3 not-xl:w-[100vh] justify-between px-[5%] lg:px-[15%] z-5 font-family-Lufga text-white duration-200'>
                ...
                <div className='flex flex-col flex-[2] md:gap-1 text-[12px] lg:text-[18px] '>
                    ...
                    <div className='p-[2%] hover:font-bold hover:text-Primary-500 hover:bg-white/10 rounded-3xl flex justify-center cursor-pointer gap-2 group/line' onClick={() => handleClick(2)}>Resume <ArrowUpRightIcon className='hidden group-hover/line:block' weight='bold' size={20} /></div>
                    <div className='p-[2%] hover:font-bold hover:text-Primary-500 hover:bg-white/10 rounded-3xl flex justify-center cursor-pointer gap-2 group/line' onClick={() => handleClick(3)}>Project <ArrowUpRightIcon className='hidden group-hover/line:block' weight='bold' size={20} /></div>
                    <div className='p-[2%] hover:font-bold hover:text-Primary-500 hover:bg-white/10 rounded-3xl flex justify-center cursor-pointer gap-2 group/line' onClick={() => handleClick(4)}>Contact <ArrowUpRightIcon className='hidden group-hover/line:block' weight='bold' size={20} /></div>
