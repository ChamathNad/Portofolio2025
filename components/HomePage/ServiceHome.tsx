        ...
        <div className={"w-full flex flex-col justify-center group bg-gray-800 rounded-[25px] "}>
          ...
          <div className='w-full h-[20%] flex'>
            ...
            <div className='mx-auto py-[3%] not-xl:w-[100vh] flex justify-between px-[5%] lg:px-[15%] z-5 font-family-Lufga text-white duration-200'>
              <span className='flex-3 text-[25px] md:text-[40px] lg:text-[50px] '>What I <span className='text-Primary-500'>Build</span>...</span>
              <span className='flex-5 text-[11px] md:text-[15px] lg:text-[20px]'>“Building immersive worlds in Unity and Unreal, crafting intuitive UIs in React, or prototyping with robotics and AR, offer versatile, full-stack solutions tailored for tomorrow.”</span>
            </div>
          </div>
