...
{       
  ...
  // On mount, shuffle the video list 
  useEffect(() => {
    setPlaylist(shuffleArray(videoList));
  }, []);

  // When one video ends, move to next one
  const handleVideoEnd = () => {
    setCurrentIndex((prevIndex) => (prevIndex + 1) % playlist.length);
  };

    return (
        <div className='w-[100%] lg:h-[1000px] not-lg:h-[700px] text-white'>

        {/*BACK VIDEO*/}
          <div className="absolute translate-y-[5px] inset-0 w-full lg:h-[1030px] not-lg:h-[700px] bg-black rounded-[8px]">
            {playlist.length > 0 && (
            <video
              key={playlist[currentIndex]} // force reload when video changes         
              src={`${baseUrlV}${playlist[currentIndex]}`}
              autoPlay
              muted
              onEnded={handleVideoEnd}
              playsInline
              preload="metadata"
              className="w-full h-full object-cover  rounded-[8px] opacity-30"
            />
          )}
          </div>
        ...
        <div className={"w-full flex justify-center group not-lg:hidden"}>
          <div className="absolute translate-y-[600px] translate-x-[0px] w-[800px] h-[400px] bg-gray-800 opacity-80 rounded-t-full z-5 " />
          <div className="relative flex justify-center  ">
            <div className="w-[913px] h-[266px]"> 
              ...
              <div className="text-center text-[90px] relative translate-y-[100px] translate-x-[0px] font-family-Lufga              
                  group-hover:translate-y-160 transition-transform duration-500 group-hover:opacity-0" >
                I&apos;m 
              ...
              <Image 
                ...
                className="w-[75px] h-[75px] relative translate-x-[145px] translate-y-[50px]                
                  group-hover:translate-y-160 transition-transform duration-600  group-hover:opacity-0"
              />
              ...
              <div className="absolute w-[300px] translate-y-[90px] lg:translate-x-[-30px] xl:translate-x-[-120px]               
                ...
                <Image 
                  ...
                  width={300}
                  height={100}
                  className="w-[50px] h-[50px] saturate-200 brightness-200 hue-rotate-180"
                />
              ...
              <div className=" relative">
                ...
                width={300}
                height={100}
                className="w-[378px] h-[333px] absolute translate-x-[285px] translate-y-[250px] z-10 saturate-150 hue-rotate-10"
                />
                <Image 
                ...
                width={300}
                height={100}
                  className="w-[101px] h-[85px] absolute translate-x-[420px] translate-y-[260px] z-15  saturate-150 hue-rotate-10
                    group-hover:translate-y-62 transition-transform duration-600 group-hover"
                />
                <Image 
                  ...
                  width={300}
                  height={100}
                  className="w-[54px] h-[22px] absolute translate-x-[464px] translate-y-[282px] z-16 saturate-150 hue-rotate-10
                ...
                <Image 
                  ...
                  width={300}
                  height={100}
                  className="w-[54px] h-[22px] absolute translate-x-[425px] translate-y-[282px] z-17 saturate-150 hue-rotate-10
                ...
                <Image 
                  ...
                  width={300}
                  height={100}
                  className="w-[383px] h-[173px] absolute translate-x-[283px] translate-y-[244px] z-20 saturate-150 hue-rotate-10    
                ...
                <Image 
                  ...
                  width={300}
                  height={100}
                  className="w-[750px] h-[200px] absolute translate-x-[100px] translate-y-[280px] z-25  opacity-0  saturate-150 hue-rotate-180      
                ...
                <Image 
                  ...
                  width={300}
                  height={100}
                  className="w-[495px] h-[225px] absolute translate-x-[340px] translate-y-[370px] z-9  saturate-150 hue-rotate-10"
                />
              </div>
              ...
              <Image src="/Images/Splash/cxVWm801 1.svg" alt="commas"  width={300} height={100}
                className="w-[55px] h-[55px] absolute translate-x-[400px] translate-y-[200px]                  
                  group-hover:translate-y-[0px] group-hover:translate-x-[280px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Group 4.svg" alt="commas"  width={300} height={100}
                className="w-[253px] h-[187px] absolute translate-x-[400px] translate-y-[200px]                  
                  group-hover:translate-y-[280px] group-hover:translate-x-[680px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Group 5.svg" alt="commas"  width={300} height={100}
                className="w-[238px] h-[150px] absolute translate-x-[400px] translate-y-[200px]                 
                  group-hover:translate-y-[280px] group-hover:translate-x-[80px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Group 6.svg" alt="commas"  width={300} height={100}
                className="w-[238px] h-[115px]  absolute translate-x-[400px] translate-y-[200px]                 
                  group-hover:translate-y-[80px] group-hover:translate-x-[620px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Group 7.svg" alt="commas"  width={300} height={100}
                className="w-[158px] h-[75px] absolute translate-x-[400px] translate-y-[200px]                  
                  group-hover:translate-y-[80px] group-hover:translate-x-[550px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Group 9.svg" alt="commas"  width={300} height={100}
                className="w-[100px] h-[100px] absolute translate-x-[400px] translate-y-[200px]                 
                  group-hover:translate-y-[60px] group-hover:translate-x-[250px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Group 10.svg" alt="commas"  width={300} height={100}
                className="w-[120px] h-[120px] absolute translate-x-[400px] translate-y-[200px]                  
                  group-hover:translate-y-[-20px] group-hover:translate-x-[520px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Group.svg" alt="commas"  width={300} height={100}
                className="w-[80px] h-[80px] absolute translate-x-[400px] translate-y-[200px]                  
                  group-hover:translate-y-[280px] group-hover:translate-x-[50px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/cxVWm801 1.svg" alt="commas"  width={300} height={100}
                className="w-[50px] h-[50px] absolute translate-x-[400px] translate-y-[200px]                  
                  group-hover:translate-y-[50px] group-hover:translate-x-[680px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/t6XNDw01 1.svg" alt="commas"  width={300} height={100}
                className="w-[70px] h-[70px] absolute translate-x-[400px] translate-y-[200px]                 
                  group-hover:translate-y-[20px] group-hover:translate-x-[150px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector.svg" alt="commas"  width={300} height={100}
                className="w-[100px] h-[100px] absolute translate-x-[400px] translate-y-[200px]                  
                  group-hover:translate-y-[180px] group-hover:translate-x-[170px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector-1.svg" alt="commas"  width={300} height={100}
                className="w-[80px] h-[80px] absolute translate-x-[400px] translate-y-[200px]                 
                  group-hover:translate-y-[380px] group-hover:translate-x-[200px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector-2.svg" alt="commas"  width={300} height={100}
                className="w-[80px] h-[80px] absolute translate-x-[400px] translate-y-[200px]                 
                  group-hover:translate-y-[100px] group-hover:translate-x-[190px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector-3.svg" alt="commas"  width={300} height={100}
                className="w-[90px] h-[90px] absolute translate-x-[400px] translate-y-[200px]                  
                  group-hover:translate-y-[260px] group-hover:translate-x-[690px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector-4.svg" alt="commas"  width={300} height={100}
                className="w-[30px] h-[30px] absolute translate-x-[400px] translate-y-[200px]                  
                  group-hover:translate-y-[200px] group-hover:translate-x-[780px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector-5.svg" alt="commas"  width={300} height={100}
                className="w-[30px] h-[30px] absolute translate-x-[400px] translate-y-[200px]                 
                  group-hover:translate-y-[380px] group-hover:translate-x-[120px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector-6.svg" alt="commas"  width={300} height={100}
                className="w-[90px] h-[90px] absolute translate-x-[400px] translate-y-[200px]                 
                  group-hover:translate-y-[400px] group-hover:translate-x-[90px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector-7.svg" alt="commas"  width={300} height={100}
                className="w-[90px] h-[90px] absolute translate-x-[400px] translate-y-[200px]                 
                  group-hover:translate-y-[100px] group-hover:translate-x-[830px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector-8.svg" alt="commas"  width={300} height={100}
                className="w-[20px] h-[20px] absolute translate-x-[400px] translate-y-[200px]                 
                  group-hover:translate-y-[220px] group-hover:translate-x-[120px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector-8.svg" alt="commas"  width={300} height={100}
                className="w-[20px] h-[20px] absolute translate-x-[400px] translate-y-[200px]               
                  group-hover:translate-y-[200px] group-hover:translate-x-[700px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector-8.svg" alt="commas"  width={300} height={100}
                className="w-[20px] h-[20px] absolute translate-x-[400px] translate-y-[200px]                 
                  group-hover:translate-y-[280px] group-hover:translate-x-[820px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vectorh.svg" alt="commas"  width={300} height={100}
                className="w-[60px] h-[60px] absolute translate-x-[400px] translate-y-[200px]                  
                  group-hover:translate-y-[0px] group-hover:translate-x-[420px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector-5.svg" alt="commas"  width={300} height={100}
                className="w-[30px] h-[30px] absolute translate-x-[400px] translate-y-[200px]                 
                  group-hover:translate-y-[100px] group-hover:translate-x-[380px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/Vector-8.svg" alt="commas"  width={300} height={100}
                className="w-[30px] h-[30px] absolute translate-x-[400px] translate-y-[200px]               
                  group-hover:translate-y-[80px] group-hover:translate-x-[470px] transition-transform duration-600 boxObject"
              />
              <Image src="/Images/Splash/robot.svg" alt="commas"  width={300} height={100}
                className="w-[80px] h-[80px] absolute translate-x-[400px] translate-y-[200px]               
                  group-hover:translate-y-[100px] group-hover:translate-x-[20px] transition-transform duration-600 boxObject"
              />
        ...
        <div className={"w-[100%] flex justify-center group lg:hidden overflow-x-clip"}>
          <div className="absolute translate-y-[500px] translate-x-[0px] w-full h-[9.7%] bg-gray-800 opacity-80 rounded-t-full z-5 " />            
          ...
          <div className="relative flex justify-center">
            <div className=" h-[266px] ">
                <div className={`mx-auto 
                                ...
                                ${openBox ? 'translate-y-[460px]  opacity-0' : 'translate-y-[50px]'}`} >  
                    Hello!
                </div>
                <Image 
                    src="/Images/commas.svg"
                ...
                <div className={`text-center text-[30px] relative translate-x-[0px] font-family-Lufga transition-transform duration-500
                                ${openBox ? 'translate-y-100  opacity-0':'translate-y-[50px]'}`} >
                ...
                <Image 
                    ...
                    ${openBox ? 'translate-y-100 opacity-0': 'translate-y-[30px]'}`}
                />
                <div className={`absolute w-[160px] translate-x-[-80px] transition-transform duration-500
                  ${openBox ? 'translate-y-[-70px]': 'translate-y-[70px]'}`}>
                    ...
                    className="w-[30px] h-[30px]  saturate-200 brightness-200 hue-rotate-180"
                    />
                ...
                <div className="relative cursor-pointer" onClick={() => setopenBox(!openBox)}>
                    ...
                    className="w-[180px] h-[150px] absolute translate-x-[10px] translate-y-[300px] z-10 saturate-150 hue-rotate-10"
                    />
                    <Image 
                    src="/Images/Lootbox/Box_bg-Light.png"
                    alt="Box_bglight"  width={300} height={100}
                    className={`w-[50px] h-[30px] absolute translate-x-[75px] z-15  transition-transform duration-600 saturate-150 hue-rotate-10 
                        ${openBox? 'translate-y-[280px] ':'translate-y-[290px] '}`}
                    />
                    <Image 
                    src="/Images/Lootbox/Box_lid1.png"
                    alt="Box_lid1"  width={300} height={100}
                    className={`w-[30px] h-[14px] absolute transition-transform duration-600  z-17 saturate-150 hue-rotate-10
                        ${openBox? 'translate-y-[282px] translate-x-[99px] ':'translate-y-[300px]  translate-x-[95px] '}`}
                    />
                    <Image 
                    src="/Images/Lootbox/Box_lid2.png"
                    alt="Box_lid2"  width={300} height={100}
                    className={`w-[30px] h-[14px] absolute z-17 transition-transform duration-600 saturate-150 hue-rotate-10 
                        ${openBox? 'translate-y-[282px] translate-x-[69px] ':'translate-y-[300px]   translate-x-[72px] '}`}
                    />
                    <Image 
                    src="/Images/Lootbox/Box_Top.png"
                    alt="Box_base"  width={300} height={100}
                    className={`w-[180px] h-[103px] absolute translate-x-[10px]  z-20 transition-transform duration-600 saturate-150 hue-rotate-10        
                        ${openBox? 'translate-y-[260px]':'translate-y-[278px]'}`}
                    />
                    <Image 
                    src="/Images/Lootbox/Box_Light.png"
                    alt="Box_base"  width={300} height={100}
                    className={`absolute w-[350px] max-w-[200%] translate-x-[-75px] z-25 screen duration-600 saturate-150 hue-rotate-180
                        ${openBox? 'translate-y-[225px] opacity-100 h-[250px]' : 'translate-y-[320px] opacity-0 h-[100px]'}`}
                    />
                    <Image 
                    src="/Images/Lootbox/Shodow.png"
                    alt="Box_Shadow"  width={300} height={100}
                    className="w-[300px] h-[115px] absolute translate-x-[45px] translate-y-[340px] z-9  saturate-150 hue-rotate-10"
                    />
                </div>
                ...
                <div className="relative flex max-w-[100%] translate-y-[480px] z-25">
                    <button     
                        onClick={() => handleClick(openBox? 2: 3)}               
                        className={`
                            font-family-Lufga
                            ...
                            font-bold border-2 
                            ${openBox? 'bg-Primary-100 text-Primary-500':'bg-Primary-500 text-white'}`}                     
                    >
                        {openBox ? <>Resume</> : <>Projects</>} <ArrowUpRightIcon size={22} weight="bold" />
                    </button>
                </div>
              ...
              <Image src="/Images/Splash/cxVWm801 1.svg" alt="commas"   width={300} height={100}
                className={`w-[40px] h-[40px] absolute  transition-transform duration-600 boxObject            
                  ${openBox? 'translate-y-[100px] translate-x-[30px]':'translate-x-[75px] translate-y-[250px] ' } `}
              />
              <Image src="/Images/Splash/Group 4.svg" alt="commas"  width={300} height={100}
                className={`w-[150px] h-[100px] absolute  transition-transform duration-600 boxObject     
              ...
              />
              <Image src="/Images/Splash/Group 6.svg" alt="commas"  width={300} height={100}
                className={`w-[120px] h-[75px] absolute  transition-transform duration-600 boxObject 
                  ${openBox? 'translate-y-[170px] translate-x-[180px]':'translate-x-[75px] translate-y-[250px] ' } `}
              />
              <Image src="/Images/Splash/Group 7.svg" alt="commas"  width={300} height={100}
                className={`w-[95px] h-[50px] absolute  transition-transform duration-600 boxObject 
                  ${openBox? 'translate-y-[160px] translate-x-[150px]':'translate-x-[75px] translate-y-[250px] ' } `}
              />
              <Image src="/Images/Splash/Group 9.svg" alt="commas"  width={300} height={100}
                className={`w-[45px] h-[45px] absolute  transition-transform duration-600 boxObject
                  ${openBox? 'translate-y-[170px] translate-x-[30px]':'translate-x-[75px] translate-y-[250px] ' } `}
              />
              <Image src="/Images/Splash/Group 10.svg" alt="commas"  width={300} height={100}
                className={`w-[80px] h-[80px] absolute  transition-transform duration-600 boxObject
                  ${openBox? 'translate-y-[100px] translate-x-[120px]':'translate-x-[75px] translate-y-[250px] ' } `}
              />
              <Image src="/Images/Splash/Group.svg" alt="commas"  width={300} height={100}
                className={`w-[60px] h-[60px] absolute   transition-transform duration-600 boxObject 
              ...
              />
              <Image src="/Images/Splash/t6XNDw01 1.svg" alt="commas"  width={300} height={100}
                className={`w-[50px] h-[50px] absolute  transition-transform duration-600 boxObject 
              ...
              />
              <Image src="/Images/Splash/Vector-3.svg" alt="commas"  width={300} height={100}
                className={`w-[70px] h-[70px] absolute  transition-transform duration-600 boxObject 
                  ${openBox? 'translate-y-[270px] translate-x-[200px]':'translate-x-[75px] translate-y-[250px] ' } `}
              />
              <Image src="/Images/Splash/Vector-4.svg" alt="commas"  width={300} height={100}
                className={`w-[20px] h-[20px] absolute  transition-transform duration-600 boxObject 
